...
pyautogui.moveTo(935, 112)
pyautogui.dragTo(900, 923, duration=1, button='left')
time.sleep(0.5)
...
response = client.chat.completions.create(
    ...
    messages=[
        {
            "role": "system",
            "content": """chat in hinglish moer hindi but some english too say a deep quote sometimes and reply so much funny  You are now acting as my auto-reply bot. 
